...
export default function Training() {
  ...
  return (
    <div>
      <form onSubmit={handleAddTrain} className='container'>
        <input type='date' name='date' value={form.date} onChange={handleChange} required></input>
        <input type='number' name='distance' value={form.distance} onChange={handleChange} required></input>
        <button>ok</button>
      </form>
